  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Mobile Stage Selector Button - ONLY SHOW ON MOBILE */}
        {onStageChange && (
          <div className="lg:hidden mb-3">
            <button
              ...
              className="w-full flex items-center justify-between px-3 py-2 bg-indigo-900/30 hover:bg-indigo-900/50 text-indigo-300 border border-indigo-800/50 rounded-lg text-xs font-medium transition-colors"
            >
