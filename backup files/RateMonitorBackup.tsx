...
export const RateMonitor: React.FC = () => {
  ...
  return (
    <div className="space-y-4 md:space-y-6 overflow-x-hidden pb-20 md:pb-6">
      ...
      {/* Add Closed Client Button - Centered with better UX */}
      <div className="flex justify-center">
        <Button 
          onClick={() => setShowAddModal(true)}
          className="w-full sm:w-auto bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 px-8 py-3"
          size="lg"
        >
      ...
      {/* Current Rates Grid - At the very top */}
